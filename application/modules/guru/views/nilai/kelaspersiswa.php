...
<center>
	...
	<table class="absensi">
		...
		<tr>
			...
			<td>
				<?php
					$matpel=array('2'=>'PKN','3'=>'BIN','4'=>'MAT','5'=>'IPA','6'=>'IPS','7'=>'SBK','9'=>'BJW','11'=>'PRAM');
					echo form_dropdown('matpel',$matpel,'1','id="matpel" style="font-size:12px;"');
				?>
			</td>
		</tr>
		<tr>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#simpan').click(function() {
			...
			var matpel=$('#matpel option:selected').val();
			$.ajax({
					type:'POST',
